...
const videos: VideoItem[] = [
  {
    id: "kvartira-obzor",
    title: "ЖК «Караван» изнутри",
    description: "Трёхкомнатная квартира 67,8 м² в чистовой отделке",
    tag: "Квартира",
    duration: "2:00",
  ...
  },
  {
    ...
    description: "Как оформить квартиру в ЖК «Желтоқсан 1В» — видео на казахском языке",
    tag: "Ипотека",
    duration: "0:37",
  ...
  },
  {
    ...
    description: "Об условиях покупки и выгодных ставках рассказывает специалист",
    tag: "Условия",
    duration: "0:30",
